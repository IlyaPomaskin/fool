...
@new external make: string => t<'a> = "WebSocket"
...
@send
external addOpenListener: (t<'binaryType>, @as("open") _, unit => unit) => unit = "addEventListener"
@send
external removeOpenListener: (t<'binaryType>, @as("open") _, unit => unit) => unit =
  "removeEventListener"
...
@send
external addErrorListener: (t<'binaryType>, @as("error") _, unit => unit) => unit =
  "addEventListener"
@send
external removeErrorListener: (t<'binaryType>, @as("error") _, unit => unit) => unit =
  "removeEventListener"
