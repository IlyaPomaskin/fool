...
function setWsServer(res) {
  if (!isSet.contents) {
    res.socket.server.on("listening", (function () {
              ...
              wsServer.emit(WsWebSocketServer.ServerEvents.error);
              
            })).on("upgrade", (function (req, socket, head) {
            var isWs = req.url.startsWith("/ws");
            if (isWs) {
              wsServer.handleUpgrade(req, socket, head, (function (ws, req) {
                      wsServer.emit(WsWebSocketServer.ServerEvents.connection, ws, req);
