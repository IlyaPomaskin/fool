...
import * as WsWebSocket from "../bindings/WsWebSocket.js";
import * as GameInstance from "./GameInstance.js";
import * as WsWebSocketServer from "../bindings/WsWebSocketServer.js";
                  ...
                  Belt_Result.map(Utils.tapResult(Serializer.deserializeClientMessage(Belt_Option.getWithDefault(WsWebSocket.RawData.toString(msg), "")), Log.logMessageFromClient), (function (msg) {
                          ...
                          switch (msg.TAG | 0) {
                            ...
                            case /* Lobby */3 :
                                ...
                                break;
                            case /* Progress */4 :
                                result = Belt_Result.map(GameInstance.move(msg._1, msg._2, msg._0), (function (progress) {
                                        return broadcastToPlayers(progress.players, {
                                                    TAG: /* ProgressUpdated */4,
                                                    _0: progress
                                                  });
