...
function getPlayerWithGame(playerId, gameId, unpackGame) {
  return Belt_Result.flatMap(Belt_Result.flatMap($$Storage.GameMap.get($$Storage.games, gameId), (function (game) {
                    var players;
                    players = game.TAG === /* InLobby */0 ? game._0.players : game._0.players;
                    return MOption.toResult(Belt_Option.map(Utils.findInList(players, (function (p) {
                                    ...
                                    })), "Player not found in game " + gameId);
                  })), (function (param) {
                var player = param[1];
                return Belt_Result.map(Curry._1(unpackGame, param[0]), (function (game) {
                              return [
                                      game,
                                      player
                                    ];
