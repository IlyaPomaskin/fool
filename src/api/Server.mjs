...
function broadcastToPlayers(players, $$event) {
  return Belt_List.forEach(players, (function (player) {
                return Belt_Result.map($$Storage.PlayersSocketMap.get(playersSocket, player.id), (function (socket) {
                              var tmp;
                              switch ($$event.TAG | 0) {
                                case /* ProgressCreated */3 :
                                    tmp = {
                                      TAG: /* ProgressCreated */3,
                                      _0: Game.maskForPlayer($$event._0, player.id)
                                    };
                                    break;
                  ...
                  switch (match$1.TAG | 0) {
                    case /* Player */0 :
                        result = match$1._0 !== 0 ? ({
                              TAG: /* Error */1,
                              _0: "error?"
                            }) : Belt_Result.map(GameInstance.connectPlayer(match$1._1), (function (player) {
                    ...
                    case /* Lobby */1 :
                        switch (match$1._0) {
                          case /* Create */0 :
                              result = Belt_Result.map(GameInstance.createLobby(match$1._1), (function (lobby) {
                              ...
                              break;
                          case /* Enter */1 :
                              result = Belt_Result.map(GameInstance.enterGame(match$1._1, match$1._2), (function (lobby) {
                                      return broadcastToPlayers(lobby.players, {
                                                  TAG: /* LobbyUpdated */2,
                                                  _0: lobby
                                                });
                              ...
                              break;
                          case /* Ready */2 :
                              result = Belt_Result.map(GameInstance.toggleReady(match$1._1, match$1._2), (function (lobby) {
                                      return broadcastToPlayers(lobby.players, {
                                                  TAG: /* LobbyUpdated */2,
                                                  _0: lobby
                                                });
                              ...
                              break;
                          case /* Start */3 :
                              result = Belt_Result.map(GameInstance.startGame(match$1._1, match$1._2), (function (progress) {
