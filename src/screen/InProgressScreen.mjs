...
function InProgressScreen$PlayerTableUI(Props) {
  ...
  var match = ReactDnd$1.useDrop({
        ...
        drop: (function (card, monitor) {
            ...
            console.log("IPS move", Card.cardToString(card));
            console.log("IPS didDrop", didDrop);
            Curry._2(onDrop, card, monitor);
            
          }),
        canDrop: (function (card, monitor) {
            console.log("IPS item", Card.cardToString(monitor.getItem()));
            console.log("IPS itemType", monitor.getItemType());
            console.log("IPS game", Game.toObject(game));
            console.log("IPS player", Player.toObject(player));
            return Belt_Result.isOk(MResult.tapError(MResult.tap(Game.isValidMove(game, player, card), (function (param) {
                                  console.log("IPS valid", param);
                                  
                                })), (function (param) {
                              console.log("IPS err", param);
...
function InProgressScreen$DragLayer(Props) {
  ...
  return React.createElement("div", {
              className: "fixed pointer-events-none z-50 left-0 top-0 w-full h-full"
            }, React.createElement("div", {
...
function InProgressScreen(Props) {
  ...
  var handleDrop = function (card, monitor) {
    ...
    return Curry._1(handleOptimisticMessage, {
                TAG: /* Progress */2,
                _0: {
                  TAG: /* Move */1,
                  _0: card
